...
#define MULTI_GAME_CORNER_MON              89 // Previously unused -tenaya
#define MULTI_UNUSED_SSTIDAL_2             90 // replaced by CreateLilycoveSSTidalMultichoice
#define MULTI_UNUSED_SSTIDAL_3             91 // replaced by CreateLilycoveSSTidalMultichoice
#define MULTI_UNUSED_SSTIDAL_4             92 // replaced by CreateLilycoveSSTidalMultichoice
