...
#define TRAINER_855                         855 // blake
#define TRAINER_856                         856 // blue
#define TRAINER_857                         857 // silver
#define TRAINER_858                         858
#define TRAINER_859                         859
#define TRAINER_860                         860
#define TRAINER_861                         861
#define TRAINER_862                         862
#define TRAINER_863                         863


// NOTE: Because each Trainer uses a flag to determine when they are defeated, there is only space for 9 additional trainers before trainer flag space overflows
// these flags are currently 0x410 - 0x76F
