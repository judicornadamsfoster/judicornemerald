...
#define VAR_BILL_STATE                                   0x4083 // Unused Var -tenaya 1=given eevee,2=,3=,4=,5=meet at BF, 6=temp til bill goes to pc,7=after asked to find lati,8=goes to lanettes
