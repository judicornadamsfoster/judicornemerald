...
const u16 gMetatiles_Ilex[] = INCBIN_U16("data/tilesets/secondary/ilex/metatiles.bin");
const u16 gMetatileAttributes_Ilex[] = INCBIN_U16("data/tilesets/secondary/ilex/metatile_attributes.bin");
